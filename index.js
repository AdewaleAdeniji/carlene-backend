...
const { AddCarToUser, GetCar, UpdateCar, GetUserCars } = require("./controllers/cars");
const { MaintenanceTypesController, CreateMaintenanceController, DeleteMaintenanceController, GetCarMaintenanceController } = require("./controllers/maintenance");
...
app.post('/maintenances/:carId/:maintenanceId', validateUser, CreateMaintenanceController)
app.delete('/maintenances/:carId/:maintenanceId', validateUser, DeleteMaintenanceController)
